export default function Footer({ serviceAreas, address, hicNumber }) {
  return (
    <footer className="bg-tealDark text-cream border-t border-cream/20 px-4 py-6 text-[11px] leading-snug">
      <div className="max-w-screen-lg mx-auto flex flex-col gap-3">
        <div className="text-cream/80">
          ...
          and we don’t collect rent. We are a registered NJ home improvement
          contractor providing in-unit STR support and readiness services for
          owners in Atlantic City, Ventnor, Margate, and Longport.”
        </div>
        ...
        <div className="text-cream/65">
          Registered NJ Home Improvement Contractor (HIC #{hicNumber})
        </div>
